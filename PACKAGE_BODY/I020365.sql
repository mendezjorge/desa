  ...
  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "SKN"."I020365" is
...
procedure pp_actualizar_registro(ii_movi_codi          in number,
                                 ...
                                 ii_cuot_fech_venc_ori in date,
                                 ii_cuot_fech_venc_nva in date) is
begin

   I020365.pp_validar_refi(ii_movi_codi);
   I020365.pp_actu_refi(ii_movi_codi,  ii_movi_tasa_mone, ii_cuot_fech_venc_ori, ii_cuot_fech_venc_nva);
...
exception
  ...
  procedure pp_vali_asie(i_movi_codi in number,
   ...
   begin
    ...
    I020365.pp_carg_asie(i_movi_codi => i_movi_codi);
 ...
 exception
  ...
  -- validar cancelacion de hijos
    begin
      I020365.pp_vali_movi_canc(i_movi_codi      => x.movi_codi,
  ...
  -- cheques
    begin
       I020365.pp_vali_cheq(i_movi_codi => x.movi_codi,
  ...
  -- cheques diferidos
    begin
        I020365.pp_vali_cheq_dife(i_movi_codi => x.movi_codi,
                                  o_erro_desc => v_erro_desc,
                                  o_erro_codi => v_erro_codi);
  ...
  -- validacion de retencion
    begin
      I020365.pp_vali_rete(i_movi_codi => x.movi_codi,
                           o_erro_desc => v_erro_desc,
                           o_erro_codi => v_erro_codi);
  ...
  -- validacion de cupo de tarjeta
    begin
      I020365.pp_vali_tarj_cupo(i_movi_codi => x.movi_codi,
                                o_erro_desc => v_erro_desc,
                                o_erro_codi => v_erro_codi);
  ...
  --descuentos de cheques - factura interes.
    begin
       I020365.pp_vali_fact_depo(i_movi_codi => x.movi_codi,
                                 o_erro_desc => v_erro_desc,
                                 o_erro_codi => v_erro_codi);
  ...
  --validacion de OP.
    begin
      I020365.pp_vali_orde_pago(i_movi_codi => x.movi_codi,
                                o_erro_desc => v_erro_desc,
                                o_erro_codi => v_erro_codi);
 ...
 exception
  ...
  for y in c_nietos(x.movi_codi) loop
   -- cancelaciones
   begin
    I020365.pp_vali_movi_canc(i_movi_codi      => y.movi_codi,
   ...
   -- cheques
    begin
       I020365.pp_vali_cheq(i_movi_codi => y.movi_codi,
                            o_erro_desc => v_erro_desc,
                            o_erro_codi => v_erro_codi);
  ...
  -- cheques diferidos
    begin
        I020365.pp_vali_cheq_dife(i_movi_codi => y.movi_codi,
                                  o_erro_desc => v_erro_desc,
                                  o_erro_codi => v_erro_codi);
  ...
  -- validacion de retencion
    begin
      I020365.pp_vali_rete(i_movi_codi => y.movi_codi,
                           o_erro_desc => v_erro_desc,
                           o_erro_codi => v_erro_codi);
  ...
  --descuentos de cheques - factura interes.
    begin
       I020365.pp_vali_fact_depo(i_movi_codi => y.movi_codi,
                                 o_erro_desc => v_erro_desc,
                                 o_erro_codi => v_erro_codi);
  ...
  -- validacion de cupo de tarjeta
    begin
      I020365.pp_vali_tarj_cupo(i_movi_codi => y.movi_codi,
                                o_erro_desc => v_erro_desc,
                                o_erro_codi => v_erro_codi);
  ...
  --validacion de OP.
    begin
      I020365.pp_vali_orde_pago(i_movi_codi => y.movi_codi,
                                o_erro_desc => v_erro_desc,
                                o_erro_codi => v_erro_codi);
...
exception
  ...
  if i_movi_timo_codi not in  (56,57) then
   ...
   I020365.pp_vali_movi_canc(i_movi_codi, i_movi_codi, v_resp_codi, v_resp_desc);
 ...
 exception
  ...
  -- cheques
    begin
       I020365.pp_vali_cheq(i_movi_codi => i_movi_codi,
                            o_erro_desc => v_erro_desc,
                            o_erro_codi => v_erro_codi);
  ...
  -- cheques diferidos
    begin
        I020365.pp_vali_cheq_dife(i_movi_codi => i_movi_codi,
                                  o_erro_desc => v_erro_desc,
                                  o_erro_codi => v_erro_codi);
 ...
 exception
  ...
  procedure pp_vali_rete_gral(i_movi_codi in number,
   ...
   I020365.pp_vali_rete(i_movi_codi => i_movi_codi,
                        o_erro_desc => v_erro_desc,
                        o_erro_codi => v_erro_codi);
 ...
 exception
  ...
  procedure pp_vali_fact_depo_gral (i_movi_codi in number,
    ...
    setitem('P34_PROGRESS_BAR_DESC', 'Validando cancelacion de prestamos..');
       ...
       I020365.pp_vali_fact_depo(i_movi_codi => i_movi_codi,
                                 o_erro_desc => v_erro_desc,
                                 o_erro_codi => v_erro_codi);
  ...
  procedure pp_vali_tarj_cred_gral(i_movi_codi in number,
    ...
    -- validacion de cupo de tarjeta
    begin
      I020365.pp_vali_tarj_cupo(i_movi_codi => i_movi_codi,
                                o_erro_desc => v_erro_desc,
                                o_erro_codi => v_erro_codi);
...
begin
  ...
  /*if gen_user = 'SKN' THEN
   raise_application_error(-20010,  i_movi_codi         ||'-'||
                                  i_cuot_fech_venc      ||'-'||
                                  i_mone_cant_deci      ||'-'||
                                  i_movi_tasa_mone      ||'-'||
                                  i_s_tipo_vencimiento  ||'-'||
                                  i_s_dias_entre_cuotas ||'-'||
                                  i_fec_prim_vto        ||'-'||
                                  i_cant_cuotas  );
  ...
  END IF;*/
   select count(*)
    ...
    /*if gen_user = 'SKN' THEN
     raise_application_error(-20010,v_sum_cuot_sald_mone||'-'||v_diferencia );
   ...
   if v_importe <> 0 then
     for k in c_sald loop
      ...
      for x in 1 .. v_cant_cuotas loop
         ...
         --RAISE_APPLICATION_ERROR(-20010, i_cuot_fech_venc||'  HISTORIA');
        ...
        select cuot_fech_venc fech_venc, cuot_tipo
         ...
         /* x.dias             := v_dias;
          ...
          x.cuot_impo_mmnn   := round(v_importe * i_movi_tasa_mone, 0);
          x.cuot_sald_mone   := v_importe;
          x.cuot_sald_mmnn   := round(v_importe * i_movi_tasa_mone, 0);
     ...
     --sumar la diferencia a la ultima cuota
      ...
      raise_application_error(-20010, 'No se puede realizar la Redefinicion, la cuota ya no posee saldo.');
   end if;
end;
...
procedure pp_actu_refi(i_movi_codi          in number,
                       i_movi_tasa_mone     in number,
                       i_cuot_fech_venc_ori in date,
                       i_cuot_fech_venc_nva in date) is

   cursor c_cuot is
    select cuot_impo_mone, cuot_sald_mone, cuot_fech_venc, cuot_movi_codi
      from come_movi_cuot
     where cuot_movi_codi = i_movi_codi
       and cuot_fech_venc = i_cuot_fech_venc_ori
       and cuot_sald_mone > 0
     order by cuot_fech_venc;
  ...
  v_cuot_indi_refi           varchar2(1);
  v_cuot_indi_reca_reco      varchar2(1);
  v_cuot_indi_exon           varchar2(1);
  v_cuot_fech_exon           date;
  ...
  for x in c_cuot loop
    ...
    if x.cuot_sald_mone <> x.cuot_impo_mone then
      ...
      update come_movi_cuot
       ...
       -- cargamos cuota original
 if i_cuot_fech_venc_nva is not null then

  for i in c_cuot_rede loop

      v_cuot_fech_venc           := i_cuot_fech_venc_nva;
      v_cuot_nume                := null;
      v_cuot_impo_mone           := i.cuot_impo_mone;
      v_cuot_impo_mmnn           := i.cuot_impo_mmnn;
      v_cuot_impo_mmee           := null;
      v_cuot_sald_mone           := i.cuot_impo_mone;
      v_cuot_sald_mmnn           := i.cuot_impo_mmnn;
      v_cuot_sald_mmee           := null;
      v_cuot_movi_codi           := i_movi_codi;
      v_cuot_base                := p_Codi_base;
      v_cuot_impo_dife_camb      := 0;
      ...
      v_cuot_tasa_dife_camb      := null;
      v_cuot_orpa_codi           := null;
      v_cuot_indi_refi           := 'N';--'S';
      v_cuot_indi_reca_reco      := i.cuot_indi_reca_reco;
      v_cuot_fech_venc_orig      := i.cuot_fech_venc_orig;
      v_cuot_tipo                := i.cuot_tipo;
      v_cuot_indi_exon           := 'S';
      v_cuot_fech_exon           := sysdate;


      begin

        pp_guardar_cuota_orig(i.cuot_fech_venc_orig,
                              i_movi_codi,
                              i.cuot_tipo,
                              i_cuot_fech_venc_nva);
      commit;
       ...
       select count(*)
         ...
         from come_movi_cuot_canc
        where canc_cuot_movi_codi = i_movi_codi
          and canc_cuot_fech_venc = i_cuot_fech_venc_ori;

       if v_pago = 0 then
         delete come_movi_cuot
          where cuot_fech_venc = i.cuot_fech_venc_orig
            and cuot_movi_codi = i_movi_codi
            and cuot_tipo = i.cuot_tipo;
       end if;
      ...
      exception
        when others then
          raise_application_error(-20010, 'Error al momento de actualizar cuota.' ||sqlerrm);
      end;
  ...
  pp_actu_nume_cuot(i_movi_codi);

  commit;
end;


procedure pp_guardar_cuota_orig(p_cuot_fech_venc     in date,
                                p_cuot_movi_codi     in number,
                                p_cuot_tipo          in varchar2,
                                p_cuot_fech_venc_nva in date) is

  v_cuot_codi_refi           number(20);
  v_cuot_obse_refi           varchar2(2000);
  v_cuot_user_regi           varchar2(20);
  v_cuot_fech_regi           date;
  v_cuot_fech_venc           date;
  v_cuot_nume                number(4);
  v_cuot_impo_mone           number(20, 4);
  v_cuot_impo_mmnn           number(20, 4);
  ...
  begin
    select cuot_fech_venc,
      ...
      into v_cuot_fech_venc,
           ...
           v_cuot_fech_exon
      from come_movi_cuot
     where cuot_fech_venc = p_cuot_fech_venc
       and cuot_movi_codi = p_cuot_movi_codi
       and cuot_tipo = p_cuot_tipo;

  exception
    when others then
      raise_application_error(-20010, 'HOLA');--null;
  end;

  if v_cuot_movi_codi is not null then
    begin
      select nvl(max(cuot_codi_refi), 0) + 1
        into v_cuot_codi_refi
        from come_movi_cuot_refi;
    exception
      when no_data_found then
        v_cuot_codi_refi := 1;
    end;

    v_cuot_obse_refi := 'cuota exonerada';--'cuota refinanciada';
    v_cuot_user_regi := gen_user;
    v_cuot_fech_regi := sysdate;

    begin
      insert into come_movi_cuot_refi
        (cuot_codi_refi,
         cuot_obse_refi,
         cuot_user_regi,
         cuot_fech_regi,
    ...
    insert into come_movi_cuot_rede_venc
        (rede_cuot_tipo,
         rede_cuot_movi_codi,
         rede_cuot_fech_venc,
         rede_fech_venc_rede,
    ...
    exception
      when others then
        raise_application_error(-20010, 'Error al momento de guardar cuota original... '||sqlerrm);
    end;
  end if;
end;

procedure pp_actu_nume_cuot(p_cuot_movi_codi in number) is
  v_cuot_nume      number;
  v_cuot_nume_desc varchar2(10);
  v_cant_cuot      number;
  v_inic           number;
  ...
  cursor c_cuot is
    select c.cuot_nume,
           ...
           c.cuot_fech_venc,
           m.movi_fech_emis,
           row_number() over(partition by c.cuot_movi_codi order by c.cuot_fech_venc) rn,
           count(*) over(partition by c.cuot_movi_codi) cn
      from come_movi_cuot c, come_movi m
     where c.cuot_movi_codi = m.movi_codi
       and c.cuot_movi_codi = p_cuot_movi_codi
     order by c.cuot_movi_codi, c.cuot_fech_venc;
     
begin
  
  pa_ejecuta_ddl('alter session set nls_date_format =' || '''' ||'DD-MM-YYYY' || '''');
  v_inic      := 0;
  
  for k in c_cuot loop
    if k.cuot_fech_venc = k.movi_fech_emis then
      v_inic := 1;
    end if;
    
    v_cuot_nume      := k.rn - v_inic;
    v_cant_cuot      := k.cn - v_inic;
    v_cuot_nume_desc := v_cuot_nume || '/' || v_cant_cuot;
      
    update come_movi_cuot
       set cuot_nume = v_cuot_nume,
           cuot_nume_desc = v_cuot_nume_desc
     where cuot_movi_codi = k.cuot_movi_codi
       and cuot_fech_venc = k.cuot_fech_venc;
