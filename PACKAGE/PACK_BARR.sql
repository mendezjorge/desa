  ...
  CREATE OR REPLACE EDITIONABLE PACKAGE "SKN"."PACK_BARR" is

  -- author  : jotace
  -- created : 6/7/2022 11:29:13
  -- purpose : Barrios
  ...
  procedure pp_abm_barr(v_ind            in varchar2,
                        ...
                        v_barr_base      in number);

  procedure pp_elim_regi(v_barr_codi in number);

  procedure pp_vali_elim_regi(v_barr_codi in number);
