  ...
  CREATE OR REPLACE EDITIONABLE PACKAGE "SKN"."PACK_FILE" is

  -- Author  : JUANB
  -- Created : 21/05/2024 7:34:41
  -- Purpose :

  procedure pp_get_file(v_desc in varchar2, v_file out blob);

  procedure pp_get_file_desc(v_desc in varchar2, v_file out blob);
